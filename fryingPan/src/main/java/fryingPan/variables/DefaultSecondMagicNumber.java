package fryingPan.variables;

import basemod.abstracts.DynamicVariable;
import com.megacrit.cardcrawl.cards.AbstractCard;
import fryingPan.cards.AbstractDefaultCard;

import static fryingPan.DefaultMod.makeID;
...
public class DefaultSecondMagicNumber extends DynamicVariable {
    ...
    public String key() {
        ...
        // Remember, we're using makeID so it automatically puts "fryingPan:" (or, your id) before the name.
    }
